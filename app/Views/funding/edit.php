...
<h2 class="text-2xl font-semibold text-center mb-6"> Update funding </h2>
    <form action="/funding/update" method="post" class="max-w-md mx-auto bg-white p-4 rounded shadow-md">
        <input type="hidden" name="id" value="<?=$funding['id']?>">
        <div class="mb-4">
            <label for="vsp" class="block font-semibold mb-1"> VSP </label>
            <input type="text" id="vsp" name="vsp" value="<?=$funding['vsp']?>" required
        ...
        <div class="mb-4">
            ...
            <input type="text" id="op" name="op"  value="<?=$funding['op']?>" required
                class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="modelNumber" name="model_number"  value="<?=$funding['model_number']?>" required
                class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="totalAmount" name="total_amount"  value="<?=$funding['total_amount']?>" required
                class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
